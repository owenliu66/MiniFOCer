...
void MX_HRTIM1_Init(void)
{
  ...
  NVIC_SetPriority(HRTIM1_TIMC_IRQn, NVIC_EncodePriority(NVIC_GetPriorityGrouping(),1, 0));
  ...
  LL_HRTIM_TIM_SetUpdateTrig(HRTIM1, LL_HRTIM_TIMER_B, LL_HRTIM_UPDATETRIG_TIMER_A|LL_HRTIM_UPDATETRIG_NONE);
  ...
  LL_HRTIM_TIM_SetUpdateTrig(HRTIM1, LL_HRTIM_TIMER_D, LL_HRTIM_UPDATETRIG_TIMER_C|LL_HRTIM_UPDATETRIG_NONE);
  ...
  LL_HRTIM_TIM_SetUpdateTrig(HRTIM1, LL_HRTIM_TIMER_E, LL_HRTIM_UPDATETRIG_TIMER_A|LL_HRTIM_UPDATETRIG_NONE);
  ...
  LL_HRTIM_TIM_SetUpdateTrig(HRTIM1, LL_HRTIM_TIMER_F, LL_HRTIM_UPDATETRIG_TIMER_C|LL_HRTIM_UPDATETRIG_NONE);
